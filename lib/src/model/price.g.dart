...
Price _$PriceFromJson(Map<String, dynamic> json) => Price(
  ...
  usageAggregation: $enumDecodeNullable(
    _$UsageAggregationEnumMap,
    json['usageAggregation'],
  ),
  ...
  tiers: (json['tiers'] as List<dynamic>?)
      ...
      .toList(),
  renewalInterval: $enumDecodeNullable(
    _$IntervalEnumMap,
    json['renewal_interval_unit'],
  ),
  renewalIntervalQuantity: (json['renewal_interval_quantity'] as num?)?.toInt(),
  trialInterval: $enumDecodeNullable(
    _$IntervalEnumMap,
...
Map<String, dynamic> _$PriceToJson(Price instance) => <String, dynamic>{
  ...
  'unit_price_decimal': ?instance.unitPriceDecimal,
  'setup_fee_enabled': ?instance.setupFeeEnabled,
  ...
  'renewal_interval_quantity': ?instance.renewalIntervalQuantity,
  'trial_interval_unit': ?_$IntervalEnumMap[instance.trialInterval],
  'trial_interval_quantity': ?instance.trialIntervalQuantity,
